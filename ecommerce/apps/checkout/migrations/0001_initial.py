    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_method', models.CharField(choices=[('IS', 'In Store'), ('PA', 'Physical Address'), ('DD', 'Digital Delivery')], help_text='Required', max_length=255, verbose_name='Delivery Method')),
